...
set :deploy_to, '/home/webuser/summer'
...
task :generate_500_html do
  on roles(:web) do |host|
    ...
    execute :curl, "-k", "https://#{host.hostname}/500.html", "> #{public_500_html}"
    public_404_html = File.join(release_path, "public/404.html")
    execute :curl, "-k", "https://#{host.hostname}/404.html", "> #{public_404_html}"
  end
end
